...
const FIX_TYPES = ['regex-rewrite', 'algorithm-change', 'guidance'];
...
function validateEntry(e) {
  ...
  if (f && typeof f === 'object') {
    req(FIX_TYPES.includes(f.type), 'fix.type must be regex-rewrite|algorithm-change|guidance');
